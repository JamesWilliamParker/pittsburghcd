...
const Careers = () => {
  return (
    <div className="container">
      <Card className="my-2" style={{ maxWidth: '600px', margin: 'auto' }}>
        <CardImg
          alt="Card image cap"
