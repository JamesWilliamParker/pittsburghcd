...
By using this Service and Website, You agree to the following policies, terms and
conditions.

Pittsburgh Doors & Closets® authorized DBA Pittsburgh Closets and Doors®
...
Agreement) refers to Pittsburgh Doors and Closets 1916 Babcock Blvd Pittsburgh Pa
15209
...
individual.
- **Service** refers to the Website and/or the Mobile App.
...
visit).
- **Website** refers to Pittsburgh Doors and Closets, accessible from
https://pittdac.com/
...
While using Our Service, we do NOT collect any sensitive personally identifiable
information about you unless you specifically give it to us, in which case we will hold
that information in confidence and never sell it to third parties. We may ask You to
provide Us with certain personally identifiable information that can be used to contact
...
· Usage Data
· Uploaded image files on the Website
...
- **Necessary / Essential Cookies**, Type: Session Cookies Administered by: Us Purpose:
...
those services.
- **Cookies Policy / Notice Acceptance Cookies**, Type: Persistent Cookies Administered
by: Us Purpose: These Cookies identify if users have accepted the use of cookies on the
Website.
- **Functionality Cookies**, Type: Persistent Cookies Administered by: Us Purpose: These
...
campaigns and to evaluate and improve our Service, products, services, sales,
...
You agree to indemnify, defend and hold Pittsburgh, its affiliates, its Third-Party
Licensors and third-party service providers, and its and their respective directors,
officers, employees, licensors, service providers and agents, harmless from and against
any and all claims, demands, causes of action, damages, losses, liabilities, costs or
expenses, including reasonable attorneys’ fees and disbursements, arising out of or in
connection with the Service. You agree that the Service is not required to purchase
products from Us or Affiliates, and therefore, no real damages shall be argued or given.
...
Your Purchases Though Our Dealer or Customer Network
We typically do not sell product or services to the public, but through Our Affiliates, or
Dealers. If You purchase product through any of Our Affiliates, Customers or third

parties offering Our Products or Services, You acknowledge that Dealer is
independently owned and operated and may be required to be licensed by a
responsible governmental agency. Customer represents and warrants that it has
engaged in due diligence to determine if Dealer is licensed prior to entering into this
agreement.

## Contact Us
If you have any questions about this Privacy Policy, You can contact us:
· By mail: 1916 Babcock Blvd Pittsburgh Pa 15209
· By email: lead@pittsburghclosetsanddoors.com
