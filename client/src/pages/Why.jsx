...
const Why = () => {
  ...
  const descriptionComponent = (
    <>
      ...
      <p>
        {`We firmly believe in being customer-focused, less 'promotional' without tactics and questionable discounts. The result has made us a TRUSTED partner in home storage improvement throughout the Greater Pittsburgh Region. Overall, we are the most experienced, customer service-oriented in the
  ...
  return (
    <div className="page-container">
      <ServiceCard reverse noButton image={WhyImage1} header="Quality & Beauty, Tailored to YOUR Style & Budget!" description={descriptionComponent} />
