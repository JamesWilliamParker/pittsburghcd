      ...
      <footer className="footer" style={{ borderTop: '1px solid #ccc', paddingTop: '50px' }}>
        <div className="footer-column">
          ...
          <div className="footer-content">
            <p style={{ marginBottom: '.1px', fontSize: '18px' }}>Address: Pittsburgh Closets & Doors</p>
            <p style={{ marginBottom: '10px', fontSize: '18px' }}>1916 Babcock Blvd., Pittsburgh, PA 15209</p>
            <p style={{ marginBottom: '10px', fontSize: '18px' }}>Office: 724-302-9514</p>
            <p style={{ marginBottom: '10px', fontSize: '18px' }}>Showroom: 724-209-4680</p>
            <p style={{ marginBottom: '10px', fontSize: '18px' }}>License: #PA140165</p>
          </div>
        </div>
